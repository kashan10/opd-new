...
<div class="container-fluid">
    ...
    <section>
    <div class="container">    
    <form action="{{ route('doctor.update',$doctor->user->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="card-body" style="margin-bottom: 5px; padding-bottom: 0px;">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="name"><strong>Name with Initials:&nbsp;</strong></label>
                            <input class="form-control" type="text" id="service_name" placeholder="A.B.C.Perera" name="name" value="{{ $doctor->user->name }}" required>
                        </div>
                        @error('name')
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="number" name="age" placeholder="25 years" min="20" max="80" value="{{ $doctor->age }}">
                        </div>
                        @error('age')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea class="form-control" id="service_description" rows="5" name="address" placeholder="No.31, Market Road, Main-Street, Matara."  required>{{$doctor->address}}</textarea>
                        @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="email"><strong>Email:&nbsp;</strong></label>
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$doctor->user->email}}" required >
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="telephone_no"><strong>Telephone Number:</strong></label>
                            <input class="form-control" type="telno" id="telno" placeholder="07X XXX XXXX" name="phone" maxlength="12" value="{{ $doctor->phone }}" required>
                        </div>
                        @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="Position"><strong>Position</strong><br></label>
                            <input class="form-control" type="text" id="position" placeholder="Grade I" name="position" value="{{ $doctor->position }}" required>
                        </div>
                        @error('position')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input class="form-control" type="file" name="file" value="{{ $doctor->file }}">
                        @error('file')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
